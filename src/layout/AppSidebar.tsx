...
const navItems: NavItem[] = [
  ...
  // },
  {
    name: "Leads and Users",
    icon: <TableIcon />,
    subItems: [{ name: "Leads Data", path: "/leads-data", pro: false }, { name: "Users Data", path: "/users-data", pro: false }],
  },
  {
        ...
        <nav className="mb-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="">
              ...
              {renderMenuItems(othersItems, "main")}
            </div>
          </div>
        </nav>
      </div>
